...
export default function AdminFeatureUpdatePage() {
    ...
    function postData(e) {
        ...
        if (error)
            ...
            let item = FeatureStateData.find(x => x._id !== _id && x.name.toLowerCase() === data.name.toLocaleLowerCase())
            if (item) {
                setErrorMessage((old) => {
                    return {
                        ...old,
                            ...
                            <form onSubmit={postData}>
                                <div className="row">
                                    ...
                                    <div className="col-12 mb-3">
                                        ...
                                        <textarea name="shortDescription" value={data.shortDescription} rows={2} onChange={getInputData} className={`form-control ${show && errorMessage.shortDescription ? 'border-danger' : 'border-dark'}`} placeholder='Short Description' />
