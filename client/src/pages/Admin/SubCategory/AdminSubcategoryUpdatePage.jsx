...
export default function AdminSubcategoryUpdatePage() {
    ...
    function postData(e) {
        ...
        if (error)
            ...
            let item = SubcategoryStateData.find(x => x._id !== _id && x.name.toLowerCase() === data.name.toLocaleLowerCase())
            if (item) {
                setErrorMessage((old) => {
                    return {
                        ...old,
                ...
                <div className="container-fluid my-3 px-5">
                    <div className="row">
                        ...
                        <div className="col-md-9">
                            <h5 className='bg-dark text-light p-2 text-center'>Subcategory <Link to="/admin/subcategory"><i className='bi bi-arrow-left fs-3 float-end text-light'></i></Link></h5>
